...
public class viewPrescription extends javax.swing.JFrame {
     ...
     */
    public viewPrescription(String str) {
        initComponents();
        List<patient> pat=GlobalVariables.system.getPatientList();
        
        List<prescription> ps=GlobalVariables.system.getPrescList();
        jTextArea1.setEditable(false); //med
        jTextField1.setEditable(false); //doc
        jTextArea3.setEditable(false); //amount
        jTextArea2.setEditable(false); //test
        for(int i=0;i<pat.size();i++)
        {
              if(pat.get(i).getEmail() == null ? str == null : pat.get(i).getEmail().equals(str))
              {
                int id= pat.get(i).getPid();
                for(int j=0;j<ps.size();j++)
                {
                    if(ps.get(j).getpId()==id)
                    {
                        jTextArea1.setText(ps.get(j).getMed());
                        jTextArea2.setText(ps.get(j).getTest());
                        jTextField1.setText(ps.get(j).getDocname());
                        jTextArea3.setText(String.valueOf(ps.get(j).getAmount()));
                    }
                }
              }
        }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/info.png"))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        this.toBack();
        patientProfile pop=new patientProfile();
        pop.setVisible(true);
        pop.toFront();
