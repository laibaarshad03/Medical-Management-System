...
public class doctorList extends javax.swing.JFrame {
     ...
     */
    public doctorList(String str,String patE) {
        initComponents();
        PatientE=patE;
       ...
       // System.out.println(GlobalVariables.system.doctorCount());
        for(int i=0;i<doc.size();i++)
        {
             // System.out.println(i);
              if(doc.get(i).getDept() == null ? str == null : doc.get(i).getDept().equals(str))
              {
                 // System.out.println("hello");
                  DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                  Object row[]=new Object[1];
                  row[0]=doc.get(i).getName();
                  model.addRow(row);
    ...
    private void initComponents() {
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/doctor (3).png"))); // NOI18N
        ...
        jLabel1.setText("Availaible Doctors");
...
//        
//        int i=app.size();
//        app.get(i+1).setDocname(jTextField2.getText());
        int id=0;
        List<patient> pat=GlobalVariables.system.getPatientList();
        for(int j=0;j<pat.size();j++)
        {
              if(pat.get(j).getEmail() == null ? PatientE == null : pat.get(j).getEmail().equals(PatientE))
              {
                  id=pat.get(j).getPid();
                  break;
              }
...
//        app.get(i+1).setPatientId(id);
//        app.get(i+1).setTime(LocalTime.now());
//        app.get(i+1).setDate(LocalDate.now());
         SQL obj=new SQL();
        try
        {
            int found=obj.appoint(id, s);
            if(found==0)
            {
            ...
            {
                javax.swing.JOptionPane.showMessageDialog(null,"Please wait until your request is approved");
            }
        }
        catch(Exception e)
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        // JOptionPane.showMessageDialog(this,"Your request has been sent. Wait until it is approved.");  
         ViewDoctor obj=new ViewDoctor(jTextField1.getText());
         obj.setVisible(true);
         //dispose();
